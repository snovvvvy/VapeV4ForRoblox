...
run(function()
	...
	ChangeRole = vape.Categories.Blatant:CreateModule({
		Name = "ChangeRole",
		Function = function(callback)
			if callback then
				...
				local role = Role.Value
                
				remoteEvents:WaitForChild("OutsideRole"):FireServer(Roles[role])
                ChangeRole:Toggle()
			end
		end,
		Tooltip = "Change your role ingame.",
	})

	Role = ChangeRole:CreateDropdown({
		Name = "Role",
		List = {
			"The Stealthy",
			"The Hungry",
